...
def HomePage():
    ...
    st.markdown("<h2 style = 'color: #2B2A4C; text-align: center; font-family:montserrat'>Smart GPA & CGPA Calculator for University Students</h2>",unsafe_allow_html=True)
    st.markdown('<br>', unsafe_allow_html= True)
    st.markdown("<h6 style = 'margin: -15px; color: #2B2A4C; text-align: center ; font-family:montserrat'>A simple, interactive GPA & CGPA calculator for university students using the Nigerian grading system. Built with Streamlit, it lets students input scores across multiple semesters and sessions to instantly compute GPA and CGPA.</h6>",unsafe_allow_html=True)
